...
void loop()
{
  ...
  {                                                     //if the switch is in the ON position
    ...
    {
      botDirection = "f";       //read the characters in the command until you reach the first space
      distance = 900;           //read the characters in the command until you reach the second space
      ...
      {
        rightMotor(400);                                //drive the right wheel forward
        leftMotor(400);                                 //drive the left wheel forward
